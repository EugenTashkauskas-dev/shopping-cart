    ...
    return (
        <div className="w-10 h-10 fixed right-2 bottom-2 xl:top-2 z-100">
            <div className="relative">
                <button className={classnames("w-10 h-10 border-0 outline-0 cursor-pointer", {
                ...
                >
                    ...
                    {items.length > 0 && <div className='absolute w-6 h-6 right-0 bottom-0 bg-red-500 rounded-full text-center'>
